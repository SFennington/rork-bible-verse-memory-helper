...
import { CheckCircle2, XCircle, ArrowRight, Home, ArrowLeft, Eye, EyeOff, Zap } from 'lucide-react-native';
                ...
                <View style={styles.debugButtonsContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setUserInput(currentVerse?.text || '');
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setUserInput('This is wrong for testing');
                      setTimeout(() => checkAnswer(), 100);
                    }}
                    activeOpacity={0.8}
                  >
